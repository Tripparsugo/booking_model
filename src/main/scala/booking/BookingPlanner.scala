...
//  }
//
//  private def registerTrip(segments: Set[FlightSegment], passenger: Passenger, fare: Fare): BookingPlanner = {
//    val newTrip = Trip(segments, fare, passenger)
//    trips += newTrip
//    this
//  }
//
...
//    var segments: Set[FlightSegment] = Set()
//
//    trait B1 {
...
//                flightCode =>
//                  seat => {
//                    segments += (new FlightSegment(from, to, marketedBy, operatedBy, seat, flightCode))
//                    TripHelper.this
//                  }
//          }
//
...
//              flightCode =>
//                seat => {
//                  segments+=(new FlightSegment(from, to, marketedBy, marketedBy, seat, flightCode))
//                  TripHelper.this
//                }
//          }
//        }
